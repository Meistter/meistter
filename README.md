...
| Trending Movies Web made on Angular consuming TheMovieDB  | Trending Movies on Javascript Vanilla  |
| ------------ | ------------ |
| <img width="300px" src="https://iili.io/HEPRJR9.md.jpg" alt="HEPRJR9.md.jpg" border="0">  | <img width="500px" src="https://i.ibb.co/1R0NHB9/coolmovies-Vanilla.jpg" alt="coolmovies-Vanilla" border="0">  |
...
| a  | Vanilla Learning Web Page using API  |
| a  | <img  width="500px" src="https://iili.io/HEPMowQ.md.jpg" alt="HEPMowQ.md.jpg" border="0">  |
| a  |  Deploy Web: [JS Cats Api](https://meistter.github.io/Consumo-De-Apis/ "meistter.github.ip") Repository: [Cat Landing Page](https://github.com/Meistter/Consumo-De-Apis "Github Repository")  |
