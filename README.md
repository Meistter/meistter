...
| Trending Movies Web made on Angular using TheMovieDB API  | Trending Movies on Javascript Vanilla  |
|:------------:|:------------:|
...
| Web Store Venta de Productos  | Vanilla Learning Web Page using API  |
